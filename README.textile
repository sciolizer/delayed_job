...
If you're upgrading an existing app from 2.1.4 to 2.1.5, you will need
to add an index to the delayed_jobs table.

<pre>
class DelayedJobNewIndex < ActiveRecord::Migration
  def self.up
